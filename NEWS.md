...
Visit the documentation to see the comprehensive changelog regarding the stable version. 

This News file keep track of devel-features and how they are incorporated into the main branch.
...
New features implemented based on LongAIRR 1.0.0 (stable)

Changes will be integrated into LongAIRR 1.1.0 (stable)

### LongAIRR 1.2.4-devel

Documentation rework. Adding ./docs directory including full documentation for
readTheDocs integration.
Also shortened the main README of the repository and removed the extended_documentation.

Last commit of this PR. Changes will move to MAIN as part of LongAIRR 1.1.0
